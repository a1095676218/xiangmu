...
<body>
	...
	<div class="dkContainer">
		<div class="dkNav">
			<ul class="list-group">
				<li class="list-group-item"><a href="http://localhost/ajx/src/html/caibuy.html">我的购物车</a></li>
				<li class="list-group-item"><a href="javascript:">修改密码</a></li>
				<li class="list-group-item"><a href="http://localhost/ajx/src/index.html">退出</a></li>
			</ul>
		</div>
		<div class="dkBody">
